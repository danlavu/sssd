"""
SSSD Dynamic DNS Tests Cases

:requirement: dyndns
"""

"""
The following are proposed framework changes that are required before we can add these tests.

# Provider hosts
  ad, samba, ipa host - backup dns server
  ad, samba, ipa host - restore dns server
  client role - backup ethernet interfaces ?
  client role restore ethernet interfaces ?
