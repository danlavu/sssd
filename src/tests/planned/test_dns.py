...
def test_dns__different_hostnames():
    """
    :title: Check different hostname values
    :setup:
        1. Set the client hostname using ‘hostnamectl’
        2. Enable dynamic DNS and start SSSD
    :steps:
        1. Lookup the hostname
    :expectedresults:
        1. Hostname matches expected result
    :customerscenario: False
    """

def test_dns__set_hostname():
    """
    :title: Set hostname in SSSD
    :setup:
        1. Set the client hostname using ‘hostnamectl’
        2. Enable dynamic DNS and set ‘ad_hostname = hostname` and start SSSD
    :steps:
        1. Lookup the hostname
    :expectedresults:
        1. Hostname is configuration value
    :customerscenario: False
    """
